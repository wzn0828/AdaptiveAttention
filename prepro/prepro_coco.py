...
def encode_captions(imgs, params, wtoi):
    ...
    caption_counter = 0
    counter = 1  # wzn: a question, i think here should be 0
    for i, img in enumerate(imgs):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_val', default=2000, type=int,
    ...
    parser.add_argument('--images_root', default='/home/jiasen/dataset/coco/',
